 ...
 <li><a class="sidebar-sub-toggle"><i class="ti-calendar"></i>Reservas <span class="badge badge-primary"></span><span class="sidebar-collapse-icon ti-angle-down"></span></a>
  ...
  <li><a class="sidebar-sub-toggle"><i class="ti-stamp"></i>Asistencia Empleados <span class="badge badge-primary"></span><span class="sidebar-collapse-icon ti-angle-down"></span></a>
    ...
    <div class="content-wrap">
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header pr">
                                  ...
                                  <a href="registro_reservas2.php" class="btn btn-success btn-rounded m-b-10">Crear Reserva</a>
                                        <!--
		...
		<?php 
			//Paginador
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM reserva WHERE estatus = 1 ");
			...
			$query = mysqli_query($conection,"SELECT c.codreserva, cl.nombre,c.cab, c.cantpasajeros, c.nhabitaciones, c.importe, c.tipodepago, c.fechaingreso, c.fechasalida , c.descripcion FROM reserva c
														INNER JOIN cliente cl
														ON c.cliente = cl.idcliente
											 WHERE c.estatus = 1 ORDER BY c.codreserva ASC LIMIT $desde,$por_pagina 
				");
			...
			?>
				<tr>
					<td><?php echo $data["codreserva"]; ?></td>
					...
					<td>
						<a class="ti-pencil-alt" href="editar_reservas2.php?id=<?php echo $data["codreserva"]; ?>"></a>
						

						<?php if($_SESSION['rol']== 1){ ?>
					
						|
						<a class="ti-trash" href="eliminar_confirmar_reservas2.php?id=<?php echo $data["codreserva"]; ?>"></a>
				<?php } ?>
		...
		<?php 
		 ...
		 ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer">
                                <p>Franco Orlando - 2019 </span> <a href="#" class="page-refresh">Refresh Dashboard</a></p>
                            </div>
                        </div>
                    </div>
                </section>
