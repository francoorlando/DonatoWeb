...
<?php 
			...
			if(empty($busqueda))
			{
				header("location: lista_clientes2.php");
                            ...
                            <div class="card alert">
                                <div class="card-header pr">
                                    ...
                                    <div class="search-action">
                                       <a href="registro_cliente2.php" class="btn btn-success btn-rounded m-b-10">Crear Cliente</a>
                          
                    
                                         
                                        <div class="search-type dib">

                                           <form action="buscar_cliente2.php" method="get" >
		...
		<?php 
			...
			?>
				<tr>
					...
					<td>
						<a class="ti-pencil-alt" href="editar_cliente2.php?id=<?php echo $data["idcliente"]; ?>"></a>
						

						<?php if($_SESSION['rol']== 1){ ?>
					
						|
						<a class="ti-trash" href="eliminar_confirmar_cliente2.php?id=<?php echo $data["idcliente"]; ?>"></a>
				<?php } ?>
