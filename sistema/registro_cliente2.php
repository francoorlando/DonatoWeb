    ...
    if(!empty($_POST))
    {
        ...
        if(empty($_POST['dni']) || empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])|| empty($_POST['email']))
        {
            ...
            if($result > 0){
                ...
                $query_insert = mysqli_query($conection,"INSERT INTO cliente(dni,nombre,telefono,direccion,email,usuario_id)
...
<body class="sidebar-hide">
 ...
 <li><a class="sidebar-sub-toggle"><i class="ti-calendar"></i>Reservas <span class="badge badge-primary"></span><span class="sidebar-collapse-icon ti-angle-down"></span></a>
    ...
    <div class="content-wrap">
        ...
        <a href="lista_clientes2.php" class="ti-back-left btn btn-primary btn-rounded m-b-10  " > Volver</a>
            ...
            <form action="" method="post">
                ...
                <input type="number" name="dni" id="dni" placeholder="" class="form-control input-rounded">
                ...
                <input type="text" name="nombre" id="nombre" placeholder="" class="form-control input-rounded">
                ...
                <input type="number" name="telefono" id="telefono" placeholder="" class="form-control input-rounded">
                ...
                <input type="text" name="direccion" id="direccion" placeholder="" class="form-control input-rounded">
                ...
                <input type="text" name="email" id="email" placeholder="" class="form-control input-rounded">
                ...
                <input type="submit" value="Guardar Cliente" class="btn btn-primary btn-rounded m-b-10 m-l-5">
