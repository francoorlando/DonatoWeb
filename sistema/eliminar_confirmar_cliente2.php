...
<section id="container">
		<div class="data_delete">
			...
			<h4><p>Cliente: <span><?php echo $nombre; ?></span></p><h4>
          
			<h4><p>DNI: <span><?php echo $dni; ?></span></p></p><h4>
			<h4><p>Telefono: <span><?php echo $telefono; ?></span></p></p><h4>
			<h4><p>Direccion: <span><?php echo $direccion; ?></span></p></p><h4>
             <h4><p>Email: <span><?php echo $email; ?></span></p></p><h4>
