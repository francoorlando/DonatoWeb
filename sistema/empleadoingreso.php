    ...
    if(!empty($_POST))
    {
        ...
        if(empty($_POST['fechaingreso']))
        {
            ...
            $usuario_id = $_SESSION['idUser'];
                ...
                $query_insert = mysqli_query($conection,"INSERT INTO turno (fechaingreso,usuario_id)
                VALUES('$fechaingreso','$usuario_id')");
                if($query_insert){
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Ingresar Entrada</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<section id="container">
    ...
    <!-- <h4><p>Fecha y Hora de Ingreso: <span><?php echo $fechaingreso; ?></span></p><h4> -->
              ...
              <center>    <h4><label for="fechaingreso">Fecha  y  Hora de Ingreso</label><h4></center>
                <input type="datetime" style="width:280px" name="fechaingreso" id="fechaingreso" placeholder="" class="form-control input-rounded" value="<?php echo $fechai; ?>" readonly>
