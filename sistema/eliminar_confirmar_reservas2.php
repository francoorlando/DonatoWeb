<?php 
    ...
    if(!empty($_POST))
    {
        ...
        $query_delete = mysqli_query($conection,"UPDATE reserva SET estatus = 0 WHERE codreserva = $codreserva ");
        mysqli_close($conection);
    ...
    if(empty($_REQUEST['id']) )
    {
        ...
        $codreserva = $_REQUEST['id'];

        $query = mysqli_query($conection,"SELECT * FROM reserva WHERE codreserva = $codreserva ");
