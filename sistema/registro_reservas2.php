	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['cliente']) || empty($_POST['cpasajeros']) || empty($_POST['nhabitaciones'])|| empty($_POST['cab'])|| empty($_POST['importe']) || empty($_POST['tipodepago']) || empty($_POST['fechaingreso']) || empty($_POST['fechasalida']))
		{
            ...
            if ($fechaingreso > $fechasalida) {
				...
				if($query_insert){
					$alert='<center><strong><p class="alert-success">Reserva creada correctamente.</p></strong></center>';
				}else{
					$alert='<center><strong><p class="alert-danger">Error al crear la reserva.</p></strong></center>';
				}
...
<body class="sidebar-hide">
 ...
 <li><a class="sidebar-sub-toggle"><i class="ti-calendar"></i>Reservas <span class="badge badge-primary"></span><span class="sidebar-collapse-icon ti-angle-down"></span></a>
    ...
    <div class="content-wrap">
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Registro Reserva</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <a href="lista_reservas2.php" class="ti-back-left btn btn-primary btn-rounded m-b-10  " > Volver</a>
                        ...
                        <option >Nº 7</option>
                         <option >Nº 8</option>
                          <option >Nº 9</option>
                                 ...
                                 <br><br><br><br><br>
			     <input type="submit" value="Crear Reserva" class="btn btn-primary btn-rounded m-b-10 m-l-5">
